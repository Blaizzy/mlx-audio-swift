...
final class Lexicon {
  ...
  init(british: Bool, directory: URL) {
    ...
    let rawGolds = DataResourcesUtil.loadGold(british: british, directory: directory)
    let rawSilvers = DataResourcesUtil.loadSilver(british: british, directory: directory)
