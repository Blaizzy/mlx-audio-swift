...
enum AppError: Error, LocalizedError, CustomStringConvertible {
    ...
    var description: String {
        ...
        case .unsupportedModelRepo(let repo):
            "Unsupported STT model repo: \(repo). Expected NemotronASR, FireRedASR2, SenseVoice, GLMASR, Qwen3ASR, MiMo-V2.5-ASR, VoxtralRealtime, CohereTranscribe, Parakeet, Whisper, or Qwen3ForcedAligner."
        case .missingTextForForcedAlignment:
        ...
        print(
            ...
            Options:
              --model <repo>                Model repo id.
                                            ...
                                            Supported families: FireRedASR2, SenseVoice, Qwen3-ASR, GLM-ASR, MiMo-V2.5-ASR, Voxtral, Cohere, Parakeet, Whisper, Qwen3-ForcedAligner
