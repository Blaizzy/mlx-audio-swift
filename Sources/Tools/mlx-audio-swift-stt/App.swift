...
enum AppError: Error, LocalizedError, CustomStringConvertible {
    ...
    var description: String {
        ...
        case .unsupportedModelRepo(let repo):
            "Unsupported STT model repo: \(repo). Expected FireRedASR2, SenseVoice, GLMASR, Qwen3ASR, VoxtralRealtime, CohereTranscribe, Parakeet, Whisper, or Qwen3ForcedAligner."
        case .missingTextForForcedAlignment:
