...
public enum STSModelUtilsError: Error, LocalizedError, CustomStringConvertible {
...
public enum STSModelUtils {
    ...
    public static func loadModel(
        ...
        guard let repoID = Repo.ID(rawValue: modelRepo) else {
            throw STSModelUtilsError.invalidRepositoryID(modelRepo)
        }
    ...
    public static func loadModel(
        ...
        guard let resolved else {
            throw STSModelUtilsError.unsupportedModelType(modelType)
        }
        ...
        default:
            throw STSModelUtilsError.unsupportedModelType(resolved)
        }
    }
